...
import messages from "@/../messages/pages/ContratoDeAdesion.json";
import styles from "./main.module.scss";

const title = "Contrato de adhesion|Banco de Comercio";
...
export default function Page() {
  const { t } = useRichTranslations("Content.ContratoDeAdesion");
